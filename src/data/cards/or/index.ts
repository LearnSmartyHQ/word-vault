...
export const dir_or: Record<string, () => Promise<IOxford>> = {
  ...
  "organization": () => import("./organization.json") as unknown as Promise<IOxford>,
  "organizational": () => import("./organizational.json") as unknown as Promise<IOxford>,
  ...
  "orientation": () => import("./orientation.json") as unknown as Promise<IOxford>,
